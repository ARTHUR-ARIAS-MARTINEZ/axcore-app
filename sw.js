const CACHE_NAME = 'axcore-v5.72-fusiones';
const urlsToCache = [
  './',
  './index.html?v=20260822a',
  './index.css?v=20260822a',
  './premium.css?v=20260822a',
  './profile-persist.js?v=20260822a',
  './app.js?v=20260822a',
  './knowledge.js?v=20260822a',
  './logo.png',
  './logo_coach.png',
  './manifest_vip.json',
  './coach.html',
...
const optionalCache = [
  './premium-badges.js?v=20260822a',
  './premium-extras.js?v=20260822a',
  './axcore-back.js?v=20260822a',
